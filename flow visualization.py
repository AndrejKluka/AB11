...
<<<<<<< HEAD
gridToVTK("./calculated data/" + data_set[0] + "-" + str(n_elements+1) + "of" + str(np.shape(u)[0]) , xvtk, yvtk, zvtk, pointData = {method: vspace})
=======
<<<<<<< HEAD
gridToVTK("./calculated data/" + data_set[0] + "-" + str(n_elements) + "of" + str(np.shape(u)[0]) , xvtk, yvtk, zvtk, pointData = {method: vspace})
=======
gridToVTK("./calculated data/" + data_set[0] + "-" + str(n_elements) + "of" + str(np.shape(u)[0]) , xvtk, yvtk, zvtk, pointData = {method: vspace})
>>>>>>> 4870801be5383d55a8a959f6f11604d86382c5bb
